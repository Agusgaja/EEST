      ...
      <div className="space-y-6">
        ...
        <div className="glass-card overflow-hidden rounded-2xl">
          ...
          <form onSubmit={handleSaveContact} className="px-6 py-5">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                <label htmlFor="tecnico-email" className={labelClass}>
                  Correo electrónico
                </label>
              ...
              <div>
                <label htmlFor="tecnico-phone" className={labelClass}>
        ...
        <div className="glass-card overflow-hidden rounded-2xl">
          ...
          <div className="px-6 py-5">
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center rounded-full bg-teal-100 px-3 py-1 text-sm font-semibold text-teal-700 dark:bg-teal-500/20 dark:text-teal-300">
                {user?.rol || "Técnico"}
              </span>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Tenés acceso al panel de técnico para gestionar tus tickets asignados.
              </p>
            </div>
          </div>
        </div>
